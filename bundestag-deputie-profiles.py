...
for c in string.ascii_uppercase:
    url = "https://www.bundestag.de/ajax/filterlist/de/abgeordnete18/-/440460/h_3b8326811f14c63004d3675a926daac6?limit=20&noFilterSet=false&prsnNachname=440448%23{}*".format(c)
    print("{}:     {}".format(c, url))
